...
kony.ui = {
	...
	Widget: function(bconfig, lconfig, pspconfig) {
		...
		defineSetter(this, "padding", function(val) {
			...
			iscontentDriven && $KU.setLayoutConfig(this, val, oldvalue);
		});
		...
		this.frame = {};
		this.layoutConfig = {self: true, children: false};
		...
		defineSetter(this, "left", function(val) {
			var oldvalue = left;
			left = val;	
			$KU.setLayoutConfig(this, val, oldvalue);			
		});
...
kony.ui.Widget.prototype.setGetterSetter = function() {
	...
	defineSetter(this, "isVisible", function(val) {
		...
		this.isvisible = val;
		(oldValue != val) && kony.model.updateView(this,  "isvisible" , val);
	});
