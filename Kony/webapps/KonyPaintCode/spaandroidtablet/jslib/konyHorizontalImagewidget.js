...
$KW.HStrip =
{
	...
	initializeStripView: function(strip)
	{
		...
		var stripDomNode = widgetModel.showarrows && widgetModel.leftarrowimage && widgetModel.rightarrowimage ? strip.children[1] : strip.children[0]; // get scroller DOM Node to initialize the Kony scroller
