...
<head>    
   ...
   <%if(deviceCategory.equalsIgnoreCase("nth")){
        ...
        if(userAgent.indexOf("MSIE 10.0") != -1 || userAgent.indexOf("Trident") != -1)
        {
        	isIECSSLoaded = true;
        %>
        	<style id="theme" type="text/css" media="screen">@import "<%= String.format("%s/%s%s/kony%sadvie10%s.css?ver=%s", gpath, deviceCategory, WEBUtil.getTheme(), deviceCategory, 320,version) %>";</style>
        <%
        }
