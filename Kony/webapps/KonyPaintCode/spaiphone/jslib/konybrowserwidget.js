...
$KW.Browser = {	
    ...
    render: function(browserModel, context){
        ...
        {
        	//FTR691: return window object to execute javascript using browserObject.evaluateJavaScript
        	var windowHandler = "webView"+browserModel.id;
        	$KG[windowHandler] = this.openUrllink(browserModel.url, browserModel.method , browserModel.data, [browserModel.pf,browserModel.id].join('_'));
        	return "";
        }       
    },
