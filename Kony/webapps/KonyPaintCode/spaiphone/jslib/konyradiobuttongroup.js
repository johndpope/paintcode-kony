...
$KW.RadioButtonGroup = {
    ...
    eventHandler: function(eventObject, target){
		if(kony.appinit.isIE8 && target.tagName == "DIV") return; // added this return for fw2892-radio button reset issue in ie8.
        ...
        if (radiobuttonModel) {
			...
			else
			{
                ...
                if(radioref){
					radioref.call(radiobuttonModel, radiobuttonModel);
