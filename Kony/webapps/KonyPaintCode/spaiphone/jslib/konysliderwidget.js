...
$KW.Slider = {
    ...
    render: function(sliderModel, context){
		...
		{			
			...
			htmlString += '<label id="'+ id +'_minLabel" style="float: left; "class="'+sliderModel.minlabelskin+'" >'+minlabeltext+'</label>';
			htmlString += '<label id="'+ id +'_maxLabel" style="float: right; "class="'+sliderModel.maxlabelskin+'" >'+maxlabeltext+'</label>'
			htmlString += '</div>';
			...
			htmlString += '<label id="' + id + '_maxLabel" class="'+sliderModel.maxlabelskin+'" >'+maxlabeltext+'</label>';
			htmlString += '</div>';
			...
			htmlString += '<img onload = "$KW.Slider.imgLoad(this, false)" kwttype ="kSlider" kformname="'+sliderModel.pf+'" id ="'+ id +'_image" src ="'+thumbimage+'" thumbimage="'+thumbimage+'" focusimage ="'+focusthumbimage+'"style="  position: relative;  vertical-align:top;"></img>';
				
			htmlString += '</div></div>';        
			htmlString += '<div style="margin-top: 2px;" >';
			htmlString += '<label id="'+ id +'_minLabel" class="'+sliderModel.minlabelskin+'" >'+minlabeltext+'</label>'
			htmlString += '</div>';
	...
	animSlider : function(width, sliderModel, property) {
		...
		var width = $KU.getValueByParentFrame(sliderModel, valueObj, 'x');
