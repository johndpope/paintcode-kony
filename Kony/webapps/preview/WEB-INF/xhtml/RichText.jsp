...
<%
    if (request.getAttribute("segmentid") != null)
    {
        ...
        // Fix for 41223 : metaInfo skin applying when RichText placed in segment
        String widgetSkin1 = "";
        if (request.getAttribute("widgetSkin1") != null) {
              widgetSkin1 = (String)request.getAttribute("widgetSkin1"); 
        }else { 
               widgetSkin1 = (String)widget.getTable("skin"); 
        }
%>
<div id="<%=eventName%>" name="<%=eventName%>" konywidgettype="Krichtext" class="<%=widgetSkin1%>"
