...
kony.widgets.TextField = {
    ...
    // Fix for 31431: Registering textbox events for all forms.
    loadHandler: function()
    {
  ...
  textfieldGoButtonEventHandler : function(eventSource)
    {
        ...
        if(eventSource.keyCode == 10 || eventSource.keyCode == 13){
            ...
            if (konywidgettype && (konywidgettype == "Ktextfield")){
               ...
               // Fix for 28599: Calling onendediting (blur event) handler incase of GO/Done button of keypad.
               kony.widgets.TextField.textfieldBlurEventHandler(eventSource);
...
kony.widgets.Image = {
    ...
    imgLoadHandler2: function(domImg, isPopup)
    {
        ...
        */
        ...
        if(viewmode == "maintainaspectratio"){
            imgwidth = domImg.parentNode.parentNode.offsetWidth;
        }
            ...
            if (isEvent && isEvent.indexOf("yes") != -1){
                ...
                if(href != null)
                {
                    ...
                    if(params.length > 2) { //inside segment
                        ...
                        postData.push(params[6]); //original text
                    }
                }
                else
                {
...
kony.widgets.Phone = {
    ...
    phoneEventHandler : function(eventSource)
    {
		...
		//on click of outside hyperlink, get inner link href
		if(href == null) {
        	var innerAnchor = target.getElementsByTagName("a")[0];
        	if(innerAnchor)
        		href = innerAnchor.href;
        }
