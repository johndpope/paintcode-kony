...
public class StyleKit {
    ...
    public static void drawGoal(Canvas canvas, Context context, RectF frame, float goalProgress) {
        ...
        // GoalGroup
        {
            ...
            goalGroup.set(frame.left + 4f,
                frame.top + 1.25f,
                frame.left + 4f + (float) Math.floor((frame.width() - 4f) * 0.95312f + 0.5f),
                frame.top + 1.25f + (float) Math.floor((frame.height() - 1.25f) * 0.98847f - 0.25f) + 0.75f);
            
            // CircleBackgroundBezier
            RectF circleBackgroundBezierRect = CacheForGoal.circleBackgroundBezierRect;
            circleBackgroundBezierRect.set(goalGroup.left + (float) Math.floor(goalGroup.width() * 0.01639f + 0.5f) + 0f,
                goalGroup.top + (float) Math.floor(goalGroup.height() * 0.23032f - 0.25f) + 0.75f,
                goalGroup.left + (float) Math.floor(goalGroup.width() * 0.96721f + 0.5f) + 0f,
                goalGroup.top + (float) Math.floor(goalGroup.height() * 0.90671f - 0.25f) + 0.75f);
            ...
            if (goalPercentageVisible) {
                ...
                circleProgressStrokeRect.set(goalGroup.left + (float) Math.floor(goalGroup.width() * 0.01639f + 0.5f) + 0f,
                    goalGroup.top + (float) Math.floor(goalGroup.height() * 0.23032f - 0.25f) + 0.75f,
                    goalGroup.left + (float) Math.floor(goalGroup.width() * 0.96721f + 0.5f) + 0f,
                    goalGroup.top + (float) Math.floor(goalGroup.height() * 0.90671f - 0.25f) + 0.75f);
            ...
            baseBezierRect.set(goalGroup.left,
                goalGroup.top + (float) Math.floor(goalGroup.height() * 0.79009f - 0.25f) + 0.75f,
            ...
            baseBezierPath.cubicTo(goalGroup.left + goalGroup.width(), goalGroup.top + goalGroup.height() * 0.89504f, goalGroup.left + goalGroup.width(), goalGroup.top + goalGroup.height() * 0.89504f, goalGroup.left + goalGroup.width(), goalGroup.top + goalGroup.height() * 0.89504f);
            baseBezierPath.lineTo(goalGroup.left + goalGroup.width(), goalGroup.top + goalGroup.height() * 0.89504f);
            baseBezierPath.lineTo(goalGroup.left + goalGroup.width(), goalGroup.top + goalGroup.height() * 0.89504f);
            baseBezierPath.lineTo(goalGroup.left + goalGroup.width(), goalGroup.top + goalGroup.height() * 0.90029f);
            baseBezierPath.cubicTo(goalGroup.left + goalGroup.width(), goalGroup.top + goalGroup.height() * 0.94138f, goalGroup.left + goalGroup.width() * 0.96387f, goalGroup.top + goalGroup.height() * 0.97808f, goalGroup.left + goalGroup.width() * 0.9096f, goalGroup.top + goalGroup.height() * 0.99214f);
            ...
            baseBezierPath.cubicTo(goalGroup.left + goalGroup.width() * 0.03613f, goalGroup.top + goalGroup.height() * 0.97808f, goalGroup.left + goalGroup.width() * -0f, goalGroup.top + goalGroup.height() * 0.94138f, goalGroup.left + goalGroup.width() * -0f, goalGroup.top + goalGroup.height() * 0.90029f);
            baseBezierPath.cubicTo(goalGroup.left, goalGroup.top + goalGroup.height() * 0.89504f, goalGroup.left, goalGroup.top + goalGroup.height() * 0.89504f, goalGroup.left, goalGroup.top + goalGroup.height() * 0.89504f);
            baseBezierPath.lineTo(goalGroup.left, goalGroup.top + goalGroup.height() * 0.89504f);
            baseBezierPath.lineTo(goalGroup.left, goalGroup.top + goalGroup.height() * 0.89504f);
            baseBezierPath.lineTo(goalGroup.left + goalGroup.width() * -0f, goalGroup.top + goalGroup.height() * 0.8898f);
            ...
            goalPercentageTextRect.set(goalGroup.left + (float) Math.floor(goalGroup.width() * 0.03279f + 0.5f) + 0f,
                goalGroup.top + (float) Math.floor(goalGroup.height() * 0.83673f - 0.25f) + 0.75f,
                goalGroup.left + (float) Math.floor(goalGroup.width() * 0.98361f + 0.5f) + 0f,
                goalGroup.top + (float) Math.floor(goalGroup.height() * 0.95335f - 0.25f) + 0.75f);
            ...
            goalIconFlightBezierRect.set(goalGroup.left + (float) Math.floor(goalGroup.width() * 0.3129f + 0.41f) + 0.09f,
                goalGroup.top + (float) Math.floor(goalGroup.height() * 0.45072f - 0.15f) + 0.65f,
                goalGroup.left + (float) Math.floor(goalGroup.width() * 0.65574f + 0.5f) + 0f,
                goalGroup.top + (float) Math.floor(goalGroup.height() * 0.68513f - 0.25f) + 0.75f);
            ...
            if (goalCompleted) {
                ...
                starsGroup.set(goalGroup.left + (float) Math.floor(goalGroup.width() * 0.16598f + 0.37f) + 0.13f,
                    goalGroup.top,
                    goalGroup.left + (float) Math.floor(goalGroup.width() * 0.81762f - 0.38f) + 0.88f,
                    goalGroup.top + (float) Math.floor(goalGroup.height() * 0.17055f - 0.13f) + 0.63f);
                
                // Star3Bezier
                RectF star3BezierRect = CacheForGoal.star3BezierRect;
                star3BezierRect.set(goalGroup.left + (float) Math.floor(goalGroup.width() * 0.65779f + 0.37f) + 0.13f,
                    goalGroup.top + (float) Math.floor(goalGroup.height() * 0.05685f - 0.38f) + 0.88f,
                    goalGroup.left + (float) Math.floor(goalGroup.width() * 0.81762f - 0.38f) + 0.88f,
                    goalGroup.top + (float) Math.floor(goalGroup.height() * 0.17055f - 0.13f) + 0.63f);
                Path star3BezierPath = CacheForGoal.star3BezierPath;
                star3BezierPath.reset();
                star3BezierPath.moveTo(goalGroup.left + goalGroup.width() * 0.7377f, goalGroup.top + goalGroup.height() * 0.05685f);
                star3BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.76119f, goalGroup.top + goalGroup.height() * 0.09071f);
                star3BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.81371f, goalGroup.top + goalGroup.height() * 0.09613f);
                star3BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.77571f, goalGroup.top + goalGroup.height() * 0.12249f);
                star3BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.78468f, goalGroup.top + goalGroup.height() * 0.1597f);
                star3BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.7377f, goalGroup.top + goalGroup.height() * 0.14213f);
                star3BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.69073f, goalGroup.top + goalGroup.height() * 0.1597f);
                star3BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.6997f, goalGroup.top + goalGroup.height() * 0.12249f);
                star3BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.6617f, goalGroup.top + goalGroup.height() * 0.09613f);
                star3BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.71422f, goalGroup.top + goalGroup.height() * 0.09071f);
                star3BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.7377f, goalGroup.top + goalGroup.height() * 0.05685f);
                ...
                star2BezierRect.set(goalGroup.left + (float) Math.floor(goalGroup.width() * 0.38115f + 0.25f) + 0.25f,
                    goalGroup.top,
                    goalGroup.left + (float) Math.floor(goalGroup.width() * 0.60246f - 0.25f) + 0.75f,
                    goalGroup.top + (float) Math.floor(goalGroup.height() * 0.15743f) + 0.5f);
                Path star2BezierPath = CacheForGoal.star2BezierPath;
                star2BezierPath.reset();
                star2BezierPath.moveTo(goalGroup.left + goalGroup.width() * 0.4918f, goalGroup.top);
                star2BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.52432f, goalGroup.top + goalGroup.height() * 0.04688f);
                star2BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.59704f, goalGroup.top + goalGroup.height() * 0.05439f);
                star2BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.54442f, goalGroup.top + goalGroup.height() * 0.09088f);
                star2BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.55685f, goalGroup.top + goalGroup.height() * 0.1424f);
                star2BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.4918f, goalGroup.top + goalGroup.height() * 0.11808f);
                star2BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.42676f, goalGroup.top + goalGroup.height() * 0.1424f);
                star2BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.43918f, goalGroup.top + goalGroup.height() * 0.09088f);
                star2BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.38656f, goalGroup.top + goalGroup.height() * 0.05439f);
                star2BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.45928f, goalGroup.top + goalGroup.height() * 0.04688f);
                star2BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.4918f, goalGroup.top);
                ...
                star1BezierRect.set(goalGroup.left + (float) Math.floor(goalGroup.width() * 0.16598f + 0.37f) + 0.13f,
                    goalGroup.top + (float) Math.floor(goalGroup.height() * 0.05685f - 0.38f) + 0.88f,
                    goalGroup.left + (float) Math.floor(goalGroup.width() * 0.32582f - 0.38f) + 0.88f,
                    goalGroup.top + (float) Math.floor(goalGroup.height() * 0.17055f - 0.13f) + 0.63f);
                Path star1BezierPath = CacheForGoal.star1BezierPath;
                star1BezierPath.reset();
                star1BezierPath.moveTo(goalGroup.left + goalGroup.width() * 0.2459f, goalGroup.top + goalGroup.height() * 0.05685f);
                star1BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.26939f, goalGroup.top + goalGroup.height() * 0.09071f);
                star1BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.32191f, goalGroup.top + goalGroup.height() * 0.09613f);
                star1BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.2839f, goalGroup.top + goalGroup.height() * 0.12249f);
                star1BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.29288f, goalGroup.top + goalGroup.height() * 0.1597f);
                star1BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.2459f, goalGroup.top + goalGroup.height() * 0.14213f);
                star1BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.19893f, goalGroup.top + goalGroup.height() * 0.1597f);
                star1BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.2079f, goalGroup.top + goalGroup.height() * 0.12249f);
                star1BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.1699f, goalGroup.top + goalGroup.height() * 0.09613f);
                star1BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.22241f, goalGroup.top + goalGroup.height() * 0.09071f);
                star1BezierPath.lineTo(goalGroup.left + goalGroup.width() * 0.2459f, goalGroup.top + goalGroup.height() * 0.05685f);
