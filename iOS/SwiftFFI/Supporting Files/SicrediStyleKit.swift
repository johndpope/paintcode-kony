...
public class SicrediStyleKit : NSObject {
    ...
    public dynamic class func drawGoal(frame: CGRect = CGRect(x: 0, y: 0, width: 68, height: 88), goalPercentTextSize: CGFloat = 12, goalProgress: CGFloat = 1) {
        ...
        let goalPercentageTextFontAttributes = [NSFontAttributeName: UIFont.systemFont(ofSize: goalPercentTextSize), NSForegroundColorAttributeName: SicrediStyleKit.white, NSParagraphStyleAttributeName: goalPercentageTextStyle]
